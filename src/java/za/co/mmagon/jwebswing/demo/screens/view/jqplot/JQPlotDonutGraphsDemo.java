 ...
 * @since 03 Apr 2016
 */
public class JQPlotDonutGraphsDemo extends DefaultScreenDisplay
{

    public JQPlotDonutGraphsDemo()
    {
    }
    ...
    public SourceCodeScreen getSourceCodeScreen()
    {
        ...
        scs.addButton("JQ Plot Donut Demo", JQPlotDonutGraphsDemo.class);
        return scs;
    }
    ...
    public MainWindowDisplay getDefaultDisplayScreen()
    {
        ...
        barGraphsDiv1.add(mwd.getDonutGraph());
        barGraphsDiv1.add(mwd.getDonutGraphMultiple());
