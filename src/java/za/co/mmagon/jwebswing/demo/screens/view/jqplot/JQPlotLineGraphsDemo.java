 ...
 * @since 03 Apr 2016
 */
public class JQPlotLineGraphsDemo extends DefaultScreenDisplay
{

    public JQPlotLineGraphsDemo()
    {
    }
    ...
    public SourceCodeScreen getSourceCodeScreen()
    {
        ...
        scs.addButton("JQ Plot Line Demo", JQPlotLineGraphsDemo.class);
        return scs;
    }
    ...
    public MainWindowDisplay getDefaultDisplayScreen()
    {
        ...
        barGraphsDiv1.add(mwd.getLineGraphStyleOptions());

        barGraphsDiv2.add(mwd.getDateAxisGraph());
