 ...
 * @since 03 Apr 2016
 */
public class JQPlotPieGraphsDemo extends DefaultScreenDisplay
{

    public JQPlotPieGraphsDemo()
    {
    }
    ...
    public SourceCodeScreen getSourceCodeScreen()
    {
        ...
        scs.addButton("JQ Plot Bar Demo", JQPlotPieGraphsDemo.class);
        return scs;
    }
    ...
    public MainWindowDisplay getDefaultDisplayScreen()
    {
        ...
        barGraphsDiv1.add(mwd.getPieGraph());
        barGraphsDiv1.add(mwd.getPieGraphSliceMargin());
        barGraphsDiv1.add(mwd.getPieGraphWithLegend());
