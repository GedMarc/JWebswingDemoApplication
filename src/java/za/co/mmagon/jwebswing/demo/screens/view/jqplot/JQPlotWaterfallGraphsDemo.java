 ...
 * @since 03 Apr 2016
 */
public class JQPlotWaterfallGraphsDemo extends DefaultScreenDisplay
{

    public JQPlotWaterfallGraphsDemo()
    {
    }
    ...
    public SourceCodeScreen getSourceCodeScreen()
    {
        ...
        scs.addButton("JQ Plot Waterfall Demo", JQPlotWaterfallGraphsDemo.class);
        return scs;
    }
    ...
    public MainWindowDisplay getDefaultDisplayScreen()
    {
        ...
        barGraphsDiv1.add(mwd.getWaterfallBar());
        barGraphsDiv1.add(mwd.getWaterfallBarNegativeColours());
        barGraphsDiv1.add(mwd.getWaterfallBarStackDisabled());
