...
import za.co.mmagon.jwebswing.components.d3.reingoldtilfordtreejs.JWReingoldTilfordTree;
...
public class ReingoldTreeDemo extends DefaultScreenDisplay
{

    private static final long serialVersionUID = 1L;

    public ReingoldTreeDemo()
    {
        super();
    ...
    public MainWindowDisplay getDefaultDisplayScreen()
    {
        ...
        JWReingoldTilfordTree tree = new JWReingoldTilfordTree();
