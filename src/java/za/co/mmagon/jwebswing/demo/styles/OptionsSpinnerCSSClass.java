...
import za.co.mmagon.jwebswing.components.jqueryui.spinner.JQUISpinnerFeature;
 ...
 * @since 28 Apr 2015
 */
public class OptionsSpinnerCSSClass extends CSSComponent
{
    ...
    private final JQUISpinnerFeature feature;

    public OptionsSpinnerCSSClass()
    {
        super("optionsSpinner");
        feature = new JQUISpinnerFeature(this);
        addFeature(feature);
    }
